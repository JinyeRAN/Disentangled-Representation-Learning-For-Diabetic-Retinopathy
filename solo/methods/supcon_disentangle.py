...
#
#
# class SupConDisentangle(BaseMethod):
...
#                 torch.mean(mu_sps[lbl == lbl_cls], dim=0),
#                 torch.mean(sg_sps[lbl == lbl_cls], dim=0)
#             )
...
#
#             ZA = self.normal_dist(mu_cls_genert, sg_cls_genert, mu_cls_target, sg_cls_target)
