...
def main(cfg: DictConfig):
    ...
    if (True if sys.gettrace() else False): cfg.wandb.offline = True
    ...
    # saved_path = wandb_logger.version if wandb_logger else None
    dali_datamodule = PDDM(cfg, train_data_path=cfg.data.train_path, val_data_path=cfg.data.val_path,
                           transforms=transform, wandb_path=None) # saved_path)
